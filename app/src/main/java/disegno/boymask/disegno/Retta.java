...
public class Retta {
    ...
    public static Retta createRetta(Point2D p1, Point2D p2) {
        Retta r = new Retta(p1, p2);
        lista.add(r);
        return r;
    }

    public static Retta createRettaHorizontal(Point2D p1) {
        Point2D p2 = new Point2D(p1.getX() + 1000, p1.getY());
        Retta r = new Retta(p1, p2);
        lista.add(r);
        return r;
    }
    public static Retta createRettaVertical(Point2D p1) {
    ...
    private Retta(Point2D p1, Point2D p2) {
        this.p1 = p1;
        this.p2 = p2;
    }
